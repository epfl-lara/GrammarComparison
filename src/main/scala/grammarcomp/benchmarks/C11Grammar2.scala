 ...
 * Taken from 
 */
object C11Grammar2 extends Benchmark {
  import GrammarReaders._  

  def benchmarkName = "C11Grammar2"
  def benchmarkSource = "http://www.quut.com/c/ANSI-C-grammar-y.html"    

  def ebnfGrammar = bnfgrammar"""translation_unit -> external_declaration | translation_unit external_declaration
